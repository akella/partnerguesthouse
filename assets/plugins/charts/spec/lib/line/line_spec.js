(function() {
  describe('Morris.Line', function() {
    ...
    describe('rendering lines', function() {
      ...
      it('should ignore null values when options.continuousLine is true', function() {
      ...
      return it('should break the line at null values when options.continuousLine is false', function() {
        this.defaults.data[2].y = null;
        Morris.Line(this.defaults);
